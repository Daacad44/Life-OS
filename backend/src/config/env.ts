...
const envSchema = z.object({
  ...
  LOG_LEVEL: z
    ...
    .optional(),
  // Cloudflare R2 object storage for user-uploaded assets (custom alarm
  ...
  // Public base URL the bucket is served from, e.g. an R2 public bucket URL
  // (https://pub-<hash>.r2.dev) or a custom domain. Object keys are appended.
